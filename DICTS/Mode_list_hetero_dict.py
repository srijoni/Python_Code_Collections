...
hetero_dict_major = {'Student1': 99, 'Student2': 50.1, 'Student3': 74.6, 'Student4': 74, 'Student5': 96, 'Student6': 96, 'Student7': 96, 'Student8': 74.6,}


hetero_list=list()
hetero_list = list(hetero_dict_major.values())


def get_key(val):
    key1=[]
    for key, value in hetero_dict_major.items():
...
for key, value in hetero_dict.items():
    if value==max:
        ...
        print("Key for Mode", get_key(key) )
